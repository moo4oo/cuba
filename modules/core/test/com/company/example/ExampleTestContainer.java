...
public class ExampleTestContainer extends TestContainer {
    ...
    public ExampleTestContainer() {
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/example/app.properties",
    ...
    public static class Common extends ExampleTestContainer {

        public static final ExampleTestContainer.Common INSTANCE = new ExampleTestContainer.Common();
